  ...
  return (
    <div>
        <div>
            ...
            <div className='md:flex md:pt-16 justify-between px-12'>
            <div>
                <img src="/image/img-card-tsp-03.png" alt="" className='mt-8 md:-mt-8'/>
                <p className='text-xl pt-3'>Transportation</p> 
                <p className='text-slate-400'>All transportation cost we bear</p>
            </div>
            <div>
                <img src="/image/img-card-tsp-03 (1).png" alt="" className='mt-8 md:-mt-8' />
                <p className='text-xl pt-3'>Guidence</p>
                <p className='text-slate-400'>We offer the best guidence for you</p>
            </div>
            <div>
                <img src="/image/img-card-tsp-03 (2).png" alt="" className='mt-8 md:-mt-8'/>
